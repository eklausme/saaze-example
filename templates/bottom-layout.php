	...
	<footer>
		<p class="blogarea dimmedColorSansSerif"><br><br>Last generated <?= date('d-M-Y H:i:s P') ?> GMT using <a href=https://github.com/eklausme/saaze>Simplified Saaze</a><br><br></p>
	</footer>
